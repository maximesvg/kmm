...
@interface SharedNetwork : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getPokemonListWithCompletionHandler:(void (^)(SharedPokemonListResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPokemonList(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonListResponse")))
@interface SharedPokemonListResponse : SharedBase
- (instancetype)initWithCount:(SharedInt * _Nullable)count next:(NSString * _Nullable)next previous:(NSString * _Nullable)previous results:(NSArray<SharedPokemonResponse *> * _Nullable)results __attribute__((swift_name("init(count:next:previous:results:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonListResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonListResponse *)doCopyCount:(SharedInt * _Nullable)count next:(NSString * _Nullable)next previous:(NSString * _Nullable)previous results:(NSArray<SharedPokemonResponse *> * _Nullable)results __attribute__((swift_name("doCopy(count:next:previous:results:)")));
...
@property (readonly) NSArray<SharedPokemonResponse *> * _Nullable results __attribute__((swift_name("results")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonListResponse.Companion")))
@interface SharedPokemonListResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonListResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonResponse")))
@interface SharedPokemonResponse : SharedBase
- (instancetype)initWithName:(NSString * _Nullable)name url:(NSString * _Nullable)url __attribute__((swift_name("init(name:url:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonResponse *)doCopyName:(NSString * _Nullable)name url:(NSString * _Nullable)url __attribute__((swift_name("doCopy(name:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonResponse.Companion")))
@interface SharedPokemonResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
